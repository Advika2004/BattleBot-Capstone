...
#ifdef USE_USART5
extern SERIAL_HandleTypeDef* USART5_Serial_Handler;
extern ring_buffer_t USART5_Buffer_TX, USART5_Buffer_RX;
extern uint8_t USART5_HAL_Reg_Tx, USART5_HAL_Reg_Rx, USART5_Application_Reg_Tx;
#endif
#ifdef USE_USART3
extern SERIAL_HandleTypeDef* USART3_Serial_Handler;
extern ring_buffer_t USART3_Buffer_TX, USART3_Buffer_RX;
extern uint8_t USART3_HAL_Reg_Tx, USART3_HAL_Reg_Rx, USART3_Application_Reg_Tx;
#endif
